...
\title{\textbf{Introduction to the ScottKnott Package}}
\author{Faria, J. C. \and Jelihovschi, E. G. \and Allaman, I. B.}
\date{\today}
\maketitle
\tableofcontents
\newpage
...
\texttt{SK()} accepts a model formula, an \texttt{aov} object, or an \texttt{lm}
object. The \texttt{which} argument names the factor to be compared.
...
<<plot-four, fig.width=8, fig.height=7, fig.cap="The four dispersion options applied to CRD1.">>=
op <- par(mfrow = c(2, 2), mar = c(4, 3, 4, 1))

plot(sk1, dispersion = 'mm',  title = "mm  (min-max)",        d.col = 'steelblue')
plot(sk1, dispersion = 'sd',  title = "sd  (std. deviation)", d.col = 'tomato')
plot(sk1, dispersion = 'ci',  title = "ci  (individual CI)",  d.col = 'darkgreen')
plot(sk1, dispersion = 'cip', title = "cip (pooled CI)",      d.col = 'purple')
