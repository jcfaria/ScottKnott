...
plot(sk1, dispersion = 'sd',  title = 'sd (std.dev.)', d.col = 'tomato')
plot(sk1, dispersion = 'ci',  title = 'ci (indiv.CI)', d.col = 'darkgreen')
plot(sk1, dispersion = 'cip', title = 'cip (pooled)', d.col = 'purple')
