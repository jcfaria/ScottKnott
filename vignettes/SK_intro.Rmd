...
author: "Jose C. Faria, Enio G. Jelihovschi, Ivan B. Allaman"
date: "`r Sys.Date()`"
...
```{r plot-four, fig.width=8, fig.height=7, fig.cap="The four dispersion options on the same dataset (CRD1)."}
